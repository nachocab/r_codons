...
maximum_entropies <- sapply(degeneracies, function(x) -log2(1/x) )

info_gain <- t(apply(genome_entropies, 1, function(x) maximum_entropies - x ))
write.table(info_gain, opt$output)